...
using System.Data;
        ...
        {
            var step = feature.StartStep(nameof(LoadBrandsAsync));
        ...
        {
            var step = feature.StartStep(nameof(LoadFlavorsAsync));
        ...
        {
            var step = feature.StartStep(nameof(LoadArticlesAsync));
