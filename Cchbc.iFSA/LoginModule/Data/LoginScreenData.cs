...
namespace iFSA.LoginModule.Data
{
	public sealed class LoginScreenData
	{
		...
		public AgendaData AgendaData { get; }
		public Func<AppSystem, Country, Task<ReplicationConfig>> GetReplicationConfig { get; }

		public LoginScreenData(Func<UserSettings> getUserSettings, Action<UserSettings> saveUserSettings, Func<IEnumerable<Country>> getCountries, Func<MainContext, List<User>> getUsers, AgendaData agendaData, Func<AppSystem, Country, Task<ReplicationConfig>> getReplicationConfig)
		{
			...
			if (agendaData == null) throw new ArgumentNullException(nameof(agendaData));
