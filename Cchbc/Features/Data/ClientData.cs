...
namespace Cchbc.Features.Data
{
	public sealed class ClientData
	{
		...
		public ClientData(List<DbFeatureContextRow> contextRows, List<DbFeatureStepRow> stepRows, List<DbFeatureExceptionRow> exceptionRows, List<DbFeatureRow> featureRows, List<DbFeatureEntryRow> featureEntryRows, List<DbFeatureEntryStepRow> entryStepRows, List<DbFeatureExceptionEntryRow> exceptionEntryRows)
		{
